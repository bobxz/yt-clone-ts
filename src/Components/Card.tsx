        ...
        <div className='flex flex-col gap-3 pb-3 hover:scale-[101%] duration-200 ease-in-out'>
            ...
            <div className="relative">
                <Link to={`/watch/${data.videoId}/${data.channelInfo.id}`}>
                    <img src={data.videoThumbnail} className="aspect-[16/9] w-full object-cover rounded-xl bg-red-300" alt="" />
                </Link>
            ...
            <div className="flex gap-2 ">
                <Link to={`/channel/${data.channelInfo.id}`}
                    ...
                    <img src={data.channelInfo.image}
                        alt="" className="bg-red-300 rounded-full object-cover hover:scale-[108%] duration-200 ease-in-out" />
                </Link>
